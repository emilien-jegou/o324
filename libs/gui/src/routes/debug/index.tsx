...
import { TimePickerInput } from '~/ui/common/time-picker-input';
import { TimePickerRangeInput, type TimePickerValue } from '~/ui/common/time-picker-range-input';
import type { DocumentHead } from '@builder.io/qwik-city';

export default component$(() => {
  const selected = useSignal<TimePickerValue>({ start: undefined, end: undefined });

  return (
    <div class="m-8">
      <TimePickerInput />
      <hr  class="border-space-700 my-4" />
      <TimePickerRangeInput bind:value={selected} />
    </div>
  );
});

export const head: DocumentHead = { title: 'debug' };
...
//    const taskList = Object.values(tasks).sort((a, b) => b.start - a.start);
...
//
//  return (
//    <div class={cn('bg-space-900 text-white', props.class)}>
//      <div>
...
//                <label for="task_name" class="font-medium w-[150px]">
//                  Task name
//                </label>
...
//
//              <div class="flex gap-2 flex-row">
//                <label for="project" class="font-medium w-[150px]">
//                  Project
//                </label>
...
//
//              <div class="flex gap-2 flex-row">
//                <label for="tags" class="font-medium w-[150px]">
//                  Tags
//                </label>
...
//
//                await saveNewConfig(JSON.parse(config));
//                configModalIsVisible.value = false;
//              }}
//              class="flex flex-col gap-4"
//            >
...
//            >
//              <div class="flex gap-2 flex-row">
//                <label for="profile_name" class="font-medium w-[150px]">
//                  Profile name *
//                </label>
