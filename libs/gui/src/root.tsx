...
import { StateRouterPortal, StateRouterProvider, defineRouterContext } from "./ui/logics/state-router";
...
export const SidebarItem = (props: SidebarItemProps) => {
  return <button onClick$={props.onClick$} class="bg-gray-600 px-4 py-2 cursor-pointer hover:bg-gray-500 border border-gray-500">
    {props.label}
  </button>
}
