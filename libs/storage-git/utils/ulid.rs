...
pub fn ulid_from_timestamp(unix_timestamp: u64) -> eyre::Result<String> {
...
pub fn ulid_from_timestamp_with_overwrite(unix_timestamp: u64, c: char) -> eyre::Result<String> {
