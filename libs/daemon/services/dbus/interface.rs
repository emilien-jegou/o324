...
use crate::{
    ...
    services::{task_manager::TaskManagerService, task_repository::TaskRef},
};
...
impl O324ServiceInterface for O324Service {
    ...
    async fn db_query(&self, operation: dto::DbOperationDto) -> fdo::Result<dto::DbResultDto> {
        ...
        match self.task_manager_service.db_query(internal_operation).await {
            Ok(internal_result) => {
